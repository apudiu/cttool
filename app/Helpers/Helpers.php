 ...
 * @return string
 */
function formatDateTimeFromStamp($timeStamp, $dateOnly=false, $format=false) {
 ...
 * @return bool|string
 */
function tailCustom($filepath, $lines = 1000, $adaptive = true) {
 ...
 * @return string
 */
function tailFile($filepath, $lines = 1000) {
